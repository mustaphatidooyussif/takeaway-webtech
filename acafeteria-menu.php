                            ...
                            <div class="content table-responsive table-full-width">
                                <table class="table table-hover table-striped">
                                    ...
                                    <tbody>
                                       ...
                                       $retrieve_stmt = $db->retrieveByCategory("Breakfast","akorno_food_menu");
                                        //$cus4->retrieveAll();
                            ...
                            <div class="content table-responsive table-full-width">
                                <table class="table table-hover table-striped">
                                    ...
                                    <tbody>
                                       ...
                                       $retrieve_stmt = $db->retrieveByCategory("Lunch","akorno_food_menu");
                                        //$cus4->retrieveAll();
                                       //$retrieve_stmt = $db->retrieveAll("bigben_food_menu");
                            ...
                            <div class="content table-responsive table-full-width">
                                <table class="table table-hover table-striped">
                                    ...
                                    <tbody>
                                       ...
                                       $retrieve_stmt = $db->retrieveByCategory("Supper","akorno_food_menu");
                                        //$cus4->retrieveAll();
                                       //$retrieve_stmt = $db->retrieveAll("bigben_food_menu");
